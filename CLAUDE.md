...
1b. **Recognitions & certifications** (own section under hero, mirrors owner's reference screenshot): rounded panel, eyebrow + Award icon notched into the top border; typographic wordmark row — Amazon Ads (Verified Partner), Amazon SPN (Verified Partner), Amazon SAS Core, Google Ads (Partner), Clutch (5.0-rated), The Manifest (red double-square mark). All owner-provided (Aug 2026); brand-red accents, no platform logo assets.
