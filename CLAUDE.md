...
2. Problem: "Growth rarely breaks in one place." — headline reduced to clamp(1.9–3.4rem); 6 pain points as editorial stacked rows (title left ~.55fr, muted copy right, hairline rules, no numbering, no cards — owner cut the card grid as generic, Aug 2026).
