...
3. Brands: clean logo cloud (owner direction Aug 2026, replaced the BrandWall rotating tiles) — centered "Trusted by leading brands worldwide[red period]" + 9 owner-cleared logos in uniform 48px frames (flex-wrap centered, grayscale/60% opacity, colour+full opacity on hover), tiny centered permission/50+/200+ note below. Logos only — no labels or metrics on named brands.
