      ...
      <section className="relative isolate bg-white py-20 sm:py-28 lg:py-32">
        ...
        <div className="mx-auto grid max-w-[1440px] gap-14 px-6 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-10">
          <div>
            ...
            <p className="mt-10 text-xs font-bold uppercase tracking-[.2em] gm-text-red-safe">Google Ads management</p>
            <h1 className="mt-6 max-w-3xl text-5xl font-semibold leading-[.96] tracking-[-.065em] sm:text-7xl">Be there when customers are <span className="text-[#E91A24]">looking for you.</span></h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-[#596475]">Go Massive helps eCommerce brands capture high-intent demand through Google Ads strategies that connect search behaviour, product priorities, and commercial objectives.</p>
          ...
          <aside className="rounded-[2rem] border border-[#020D1F]/10 bg-[#F7F8FA] p-6 shadow-2xl shadow-[#020D1F]/10 sm:p-8">
            <div className="flex items-center justify-between border-b border-[#020D1F]/10 pb-5">
              <div><p className="text-xs font-bold uppercase tracking-[.18em] gm-text-red-safe">Google Ads focus</p><p className="mt-2 text-xl font-semibold">High-intent demand, handled with discipline.</p></div>
