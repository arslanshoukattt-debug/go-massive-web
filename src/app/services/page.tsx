...
export default function ServicesPage() {
  return <main className="bg-[#F7F8FA] text-[#020D1F]">
    ...
    <section className="bg-[#020D1F] py-20 text-white sm:py-28"><div className="mx-auto max-w-[1440px] px-6 lg:px-10">
      ...
      <div className="mt-16 grid gap-px overflow-hidden rounded-3xl border border-white/10 bg-white/10 md:grid-cols-3"><Reveal delay={0}><div className="bg-[#081B38] p-7"><span className="text-sm font-bold text-[#FF8A90]">01</span><p className="mt-8 text-2xl font-semibold">Manage</p><p className="mt-3 leading-7 text-white/55">The marketplace operations that keep growth possible.</p></div></Reveal><Reveal delay={90}><div className="bg-[#081B38] p-7"><span className="text-sm font-bold text-[#FF8A90]">02</span><p className="mt-8 text-2xl font-semibold">Acquire</p><p className="mt-3 leading-7 text-white/55">Demand capture and creation that puts the right products in front of the right people.</p></div></Reveal><Reveal delay={180}><div className="bg-[#081B38] p-7"><span className="text-sm font-bold text-[#FF8A90]">03</span><p className="mt-8 text-2xl font-semibold">Convert & expand</p><p className="mt-3 leading-7 text-white/55">The content, commerce, retention, and new-channel work that compounds demand.</p></div></Reveal></div>
    </div></section>
