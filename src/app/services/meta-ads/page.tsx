    ...
    <main id="main" className="overflow-hidden bg-[#F7F8FA] text-[#020D1F]">
      ...
      <section className="relative isolate bg-white py-20 sm:py-28 lg:py-32">
        ...
        <div className="mx-auto grid max-w-[1440px] gap-14 px-6 lg:grid-cols-[1.05fr_.95fr] lg:items-center lg:px-10">
          <div>
            <Link href="/services" className="inline-flex items-center gap-2 text-sm font-semibold text-[#596475] transition hover:text-[#020D1F]"><ArrowRight className="rotate-180" size={16} /> Services</Link>
            <p className="mt-10 text-xs font-bold uppercase tracking-[.2em] gm-text-red-safe">Meta Ads management</p>
            <h1 className="mt-6 max-w-3xl text-5xl font-semibold leading-[.96] tracking-[-.065em] sm:text-7xl">Turn attention into a <span className="text-[#E91A24]">stronger acquisition engine.</span></h1>
            <p className="mt-8 max-w-xl text-lg leading-8 text-[#596475]">Go Massive helps brands create demand through Meta Ads campaigns that bring creative, audiences, offers, and landing pages into a more useful commercial system.</p>
          ...
          <aside className="rounded-[2rem] border border-[#020D1F]/10 bg-[#F7F8FA] p-6 shadow-2xl shadow-[#020D1F]/10 sm:p-8">
            <div className="flex items-center justify-between border-b border-[#020D1F]/10 pb-5">
              <div><p className="text-xs font-bold uppercase tracking-[.18em] gm-text-red-safe">Meta Ads focus</p><p className="mt-2 text-xl font-semibold">Demand creation with commercial intent.</p></div>
              <BarChart3 className="text-[#E91A24]" size={27} />
            </div>
            <ul className="mt-7 space-y-5">
              {accountWork.map((item) => <li key={item} className="flex gap-3 text-sm leading-6 text-[#354052]"><Check className="mt-0.5 shrink-0 text-[#E91A24]" size={17} strokeWidth={3} />{item}</li>)}
            </ul>
          </aside>
        </div>
      </section>
      ...
      <section className="bg-[#F7F8FA] py-24 sm:py-32"><div className="mx-auto grid max-w-[1440px] gap-12 px-6 lg:grid-cols-2 lg:items-center lg:px-10">
        <div className="rounded-3xl border border-[#020D1F]/10 bg-white p-7 sm:p-9"><div className="flex items-center gap-3"><span className="grid h-11 w-11 place-items-center rounded-xl bg-[#E91A24]/10 text-[#E91A24]"><Target size={21} /></span><div><p className="text-sm font-semibold">Creative is a growth lever</p><p className="mt-1 text-sm text-[#596475]">Not just a deliverable.</p></div></div><p className="mt-7 leading-7 text-[#4E5A6B]">The most effective Meta Ads programs treat creative as an ongoing source of customer insight, not a one-time production task.</p></div>
        <div><p className="text-xs font-bold uppercase tracking-[.18em] gm-text-red-safe">The Go Massive standard</p><h2 className="mt-5 text-4xl font-semibold tracking-[-.055em] sm:text-6xl">More than reach. A clearer route to acquisition.</h2><p className="mt-6 max-w-xl text-lg leading-8 text-[#596475]">We help teams connect creative strategy to the outcomes they need the channel to produce, then make the next test and next decision clear.</p><div className="mt-8 flex items-center gap-3 text-sm font-semibold"><Sparkles className="text-[#E91A24]" size={19} /> Strategy, execution, and reporting in one operating rhythm.</div><Link href="/case-studies" className="mt-8 inline-flex items-center gap-2 font-semibold gm-text-red-safe transition hover:text-[#C9141D]">See how this thinking performs <ArrowRight size={16} /></Link></div>
      </div></section>
