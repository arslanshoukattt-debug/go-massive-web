...
export default function NotFound() {
  return (
    <main id="main" className="flex min-h-screen flex-col bg-white text-[#020D1F]">
      <SiteHeader />
      <section className="flex flex-1 items-center px-5 py-24 sm:px-8 lg:px-12">
        <div className="mx-auto w-full max-w-[1600px]">
          <p className="gm-num-editorial">404</p>
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-[#596475]">The address may have changed, or it never existed. Everything that does exist is one step away.</p>
          ...
          <div className="mt-14 flex flex-wrap gap-x-10 gap-y-4 border-t border-[#020D1F]/15 pt-8">
            {paths.map(([label, href]) => (
              <Link key={href} href={href} className="inline-flex items-center gap-2 text-sm font-semibold text-[#596475] transition hover:text-[#020D1F]">
