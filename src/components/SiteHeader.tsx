  ...
  return (
    <header className="gm-vt-header sticky top-0 z-50 border-b border-white/20 bg-[#07090A]/95 text-white backdrop-blur">
      <div className="mx-auto flex h-[76px] max-w-[1600px] items-center justify-between px-5 sm:px-8 lg:px-12">
        ...
        <button ref={triggerRef} type="button" onClick={() => setOpen(!open)} className="grid h-11 w-11 place-items-center border border-white/25 lg:hidden" aria-label={open ? "Close menu" : "Open menu"} aria-expanded={open} aria-controls={MOBILE_NAV_ID}>
