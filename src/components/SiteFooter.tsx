...
const columns = [
  ...
  { title: "Company", links: [["Case Studies", "/case-studies"], ["About Go Massive", "/about"], ["Growth Audit", "/growth-audit"], ["Contact", "mailto:info@go-massive.com"]] },
];
